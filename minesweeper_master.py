...
def unsolvableStructure(BoardCheck):
    ...
    for i in range(0, Row - 2):  # 检查左右两侧
        if i < Row - 3:
            if Board[i][0] == -1 and Board[i][1] == -1 and Board[i + 3][0] == -1 and Board[i + 3][1] == -1 and \
                    Board[i + 1][0] + Board[i + 2][0] == -1 \
                    or Board[i][Column - 1] == -1 and Board[i][Column - 2] == -1 and Board[i + 3][Column - 1] == -1 and \
                    Board[i + 3][Column - 2] == -1 and Board[i + 1][Column - 1] + Board[i + 2][Column - 1] == -1:
                return 1
        if Board[i][2] == -1 and Board[i + 1][2] == -1 and Board[i + 2][2] == -1 and Board[i + 1][0] + Board[i + 1][
            1] == -1 \
                or Board[i][Column - 3] == -1 and Board[i + 1][Column - 3] == -1 and Board[i + 2][Column - 3] == -1 and \
                Board[i + 1][Column - 1] + Board[i + 1][Column - 2] == -1 \
                or Board[i][0] == -1 and Board[i][1] == -1 and Board[i + 1][1] == -1 and Board[i + 2][1] == -1 and \
                Board[i + 2][0] == -1 and Board[i + 1][0] == 0 \
                or Board[i][Column - 1] == -1 and Board[i][Column - 2] == -1 and Board[i + 1][Column - 2] == -1 and \
                Board[i + 2][Column - 2] == -1 and Board[i + 2][Column - 1] == -1 and Board[i + 1][Column - 1] == 0:
            return 1
        if i < Row - 3:
            if Board[i][2] == -1 and Board[i + 3][2] == -1 and Board[i + 1][0] + Board[i + 1][1] == -1 and Board[i + 1][
                1] + Board[i + 2][1] == -1 and Board[i + 2][1] + Board[i + 2][0] == -1 \
                    or Board[i][Column - 3] == -1 and Board[i + 3][Column - 3] == -1 and Board[i + 1][Column - 1] + \
                    Board[i + 1][Column - 2] == -1 and Board[i + 1][Column - 2] + Board[i + 2][Column - 2] == -1 and \
                    Board[i + 2][Column - 2] + Board[i + 2][Column - 1] == -1:
                return 1

    for j in range(0, Column - 2):  # 检查上下两侧
        if j < Column - 3:
            if Board[0][j] == -1 and Board[1][j] == -1 and Board[0][j + 3] == -1 and Board[1][j + 3] == -1 and Board[0][
                j + 1] + Board[0][j + 2] == -1 \
                    or Board[Row - 1][j] == -1 and Board[Row - 2][j] == -1 and Board[Row - 1][j + 3] == -1 and \
                    Board[Row - 2][j + 3] == -1 and Board[Row - 1][j + 1] + Board[Row - 1][j + 2] == -1:
                return 1
        if Board[2][j] == -1 and Board[2][j + 1] == -1 and Board[2][j + 2] == -1 and Board[0][j + 1] + Board[1][
            j + 1] == -1 \
                or Board[Row - 3][j] == -1 and Board[Row - 3][j + 1] == -1 and Board[Row - 3][j + 2] == -1 and \
                Board[Row - 1][j + 1] + Board[Row - 2][j + 1] == -1 \
                or Board[0][j] == -1 and Board[1][j] == -1 and Board[1][j + 1] == -1 and Board[1][j + 2] == -1 and \
                Board[0][j + 2] == -1 and Board[0][j + 1] == 0 \
                or Board[Row - 1][j] == -1 and Board[Row - 2][j] == -1 and Board[Row - 2][j + 1] == -1 and \
                Board[Row - 2][j + 2] == -1 and Board[Row - 1][j + 2] == -1 and Board[Row - 1][j + 1] == 0:
            return 1
        if j < Column - 3:
            if Board[2][j] == -1 and Board[2][j + 3] == -1 and Board[0][j + 1] + Board[1][j + 1] == -1 and Board[1][
                j + 1] + Board[1][j + 2] == -1 and Board[1][j + 2] + Board[0][j + 2] == -1 \
                    or Board[Row - 3][j] == -1 and Board[Row - 3][j + 3] == -1 and Board[Row - 1][j + 1] + \
                    Board[Row - 2][j + 1] == -1 and Board[Row - 2][j + 1] + Board[Row - 2][j + 2] == -1 and \
    ...
    if Board[0][2] == -1 and Board[1][2] == -1 and Board[0][0] + Board[0][1] == -1 \
            ...
            or Board[0][Column - 3] == -1 and Board[1][Column - 3] == -1 and Board[0][Column - 1] + Board[0][
        Column - 2] == -1 \
            or Board[2][Column - 1] == -1 and Board[2][Column - 2] == -1 and Board[0][Column - 1] + Board[1][
        Column - 1] == -1 \
            ...
            or Board[Row - 1][Column - 3] == -1 and Board[Row - 2][Column - 3] == -1 and Board[Row - 1][Column - 1] + \
            Board[Row - 1][Column - 2] == -1 \
            or Board[Row - 3][Column - 1] == -1 and Board[Row - 3][Column - 2] == -1 and Board[Row - 1][Column - 1] + \
            ...
            or Board[Row - 1][Column - 2] + Board[Row - 2][Column - 2] + Board[Row - 2][Column - 1] == -3 and \
            ...
            or Board[Row - 3][2] == -1 and Board[Row - 1][1] + Board[Row - 2][1] == -1 and Board[Row - 2][0] + \
            Board[Row - 2][1] == -1 \
            or Board[Row - 3][Column - 3] == -1 and Board[Row - 1][Column - 2] + Board[Row - 2][Column - 2] == -1 and \
            Board[Row - 2][Column - 1] + Board[Row - 2][Column - 2] == -1 \
            or Board[2][Column - 3] == -1 and Board[0][Column - 2] + Board[1][Column - 2] == -1 and Board[1][
        Column - 1] + Board[1][Column - 2] == -1:  # 检查四个角
        return 1
    for i in range(0, Row - 2):  # 找中间的工、回、器形结构
        for j in range(0, Column - 2):
            if j < Column - 3:
                if Board[i][j] == -1 and Board[i + 1][j] == -1 and Board[i + 2][j] == -1 and Board[i][j + 3] == -1 and \
                        Board[i + 1][j + 3] == -1 and Board[i + 2][j + 3] == -1 and Board[i + 1][j + 1] + Board[i + 1][
                    j + 2] == -1:
                    return 1
            if i < Row - 3:
                if Board[i][j] == -1 and Board[i][j + 1] == -1 and Board[i][j + 2] == -1 and Board[i + 3][j] == -1 and \
                        Board[i + 3][j + 1] == -1 and Board[i + 3][j + 2] == -1 and Board[i + 1][j + 1] + Board[i + 2][
                    j + 1] == -1:
                    return 1
            if Board[i][j] == -1 and Board[i + 1][j] == -1 and Board[i + 2][j] == -1 and Board[i][j + 1] == -1 and \
                    Board[i + 2][j + 1] == -1 and Board[i][j + 2] == -1 and Board[i + 1][j + 2] == -1 and Board[i + 2][
                j + 2] == -1 and Board[i + 1][j + 1] == 0:
                return 1
            if j < Column - 3 and i < Row - 3:
                if Board[i][j] == -1 and Board[i + 3][j] == -1 and Board[i][j + 3] == -1 and Board[i + 3][
                    j + 3] == -1 and Board[i + 1][j + 1] + Board[i + 2][j + 1] == -1 and Board[i + 1][j + 1] + \
                        Board[i + 1][j + 2] == -1 and Board[i + 2][j + 1] + Board[i + 2][j + 2] == -1:
                    return 1
    return 0
...
def judgeDifficult():
    ...
    if conf['DEFAULT']['gameDifficult'] == 'B':
        return '初级'
    elif conf['DEFAULT']['gameDifficult'] == 'I':
        return '中级'
    elif conf['DEFAULT']['gameDifficult'] == 'E':
        return '高级'
    elif conf['DEFAULT']['gameDifficult'] == 'C':
        return '自定义'
...
def calScores(mode, winflag, time, operationStream, Board):
    ...
    scores['Time'] = '{:.2f}'.format(time)
    # scores['eTime'] = '{:.2f}'.format(time) if winflag else '还在写'
    ...
    # scores['Thrp'] = '还在写'
    # scores['Corr'] = '还在写'
    scores['3BV/s'] = '{:.2f}'.format(indexes['3BV'] / time) if winflag else '---'
    # scores['RQP'] = '{:.2f}'.format(time ** 2 / indexes['3BV']) if winflag else '---'
    # scores['STNB'] = '还在写'
    # scores['Ces'] = '还在写'
    # scores['Mode'] = '还在写'
    scores['Difficulty'] = str(indexes['Difficulty'])
    return scores
